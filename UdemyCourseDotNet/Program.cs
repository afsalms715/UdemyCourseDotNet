...
number1 = int.TryParse(Console.ReadLine(), out number1) ? number1 : 0;
number2 = int.TryParse(Console.ReadLine(), out number2) ? number2 : 0;
number3 = int.TryParse(Console.ReadLine(), out number3) ? number3 : 0;
largestOf3Number.FindLargestOf3Number(number1, number2, number3);
